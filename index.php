        ...
        <div class="navbar-container">
            ...
            <div class="menu-container">
                <div class="menu-items">
                    ...
                    <a class="menu-items-list" href="#" target="_self">My list</p>
            ...
            <div class="profile-menu-bar" id="ProfileMenu">
                <div class="profile-menu">
                    ...
                    <a class="profile-menu-items" href="loginpage.php" target="_self">
    ...
    <div class="container">
        <div class="content-container">
            <div class="featured-content">
                <img class="featured-title" src="images/breakingbadtitle.png">
                <p class="featured-description">A chemistry teacher diagnosed with inoperable lung cancer turns to
                    manufacturing and selling methamphetamine with a former student in order to secure his family's
                    future.</p>
            ...
            <div class="movies-list-container">
                ...
                <div class="movies-list-wrapper">
                    <div class="movies-list">
                        ...
                        <div class="movies-list-items">
                            <img class="movies-list-items-img" src="thepursuitofhappyness.webp">
                            <a href="oppenheimermovie.php"><button class="movies-list-items-button">PLAY</button></a>
                            <div class="playtrailer">
                                <video controls autoplay loop>
                                    <source src="images/trailer.mp4" type="video/mp4">
            ...
            <div class="movies-list-container">
                <h2 class="movies-list-title">TV Shows</h2>

                <div class="movies-list-wrapper">
                    <div class="movies-list">
                        <div class="movies-list-items">
                            <img class="movies-list-items-img" src="images/breakingbad1.webp">
                            <a href="oppenheimermovie.php"><button class="movies-list-items-button">PLAY</button></a>
                            <div class="playtrailer">
                                <video controls autoplay loop>
                                    <source src="images/trailer.mp4" type="video/mp4">
                        ...
                        <div class="movies-list-items">
                            <img class="movies-list-items-img" src="images/vikings.webp">
                            <a href="oppenheimermovie.php"><button class="movies-list-items-button">PLAY</button></a>
                            <div class="playtrailer">
                                <video controls autoplay loop>
                                    <source src="images/trailer.mp4" type="video/mp4">
                        ...
                        <div class="movies-list-items">
                            <img class="movies-list-items-img" src="images/friends.webp">
                            <a href="oppenheimermovie.php"><button class="movies-list-items-button">PLAY</button></a>
                            <div class="playtrailer">
                                <video controls autoplay loop>
                                    <source src="images/trailer.mp4" type="video/mp4">
                        ...
                        <div class="movies-list-items">
                            <img class="movies-list-items-img" src="images/vampirediaries.webp">
                            <a href="oppenheimermovie.php"><button class="movies-list-items-button">PLAY</button></a>
                            <div class="playtrailer">
                                <video controls autoplay loop>
                                    <source src="images/trailer.mp4" type="video/mp4">
                        ...
                        <div class="movies-list-items">
                            <img class="movies-list-items-img" src="images/bettercallsaul.webp">
                            <a href="oppenheimermovie.php"><button class="movies-list-items-button">PLAY</button></a>
                            <div class="playtrailer">
                                <video controls autoplay loop>
                                    <source src="images/trailer.mp4" type="video/mp4">
                        ...
                        <div class="movies-list-items">
                            <img class="movies-list-items-img" src="images/youngsheldon.webp">
                            <a href="oppenheimermovie.php"><button class="movies-list-items-button">PLAY</button></a>
                            <div class="playtrailer">
                                <video controls autoplay loop>
                                    <source src="images/trailer.mp4" type="video/mp4">
                        ...
                        <div class="movies-list-items">
                            <img class="movies-list-items-img" src="images/housemd.webp">
                            <a href="oppenheimermovie.php"><button class="movies-list-items-button">PLAY</button></a>
                            <div class="playtrailer">
                                <video controls autoplay loop>
                                    <source src="images/trailer.mp4" type="video/mp4">
                        ...
                        <div class="movies-list-items">
                            <img class="movies-list-items-img" src="images/thewalkingdead.webp">
                            <a href="oppenheimermovie.php"><button class="movies-list-items-button">PLAY</button></a>
                            <div class="playtrailer">
                                <video controls autoplay loop>
                                    <source src="images/trailer.mp4" type="video/mp4">
